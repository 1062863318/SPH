...
export default {
  ...
  computed: {
    ...
    // })
    // mapGetters里面的写法:传递的数组,因为getters计算是没用划分模块[home,search]
  ...
  methods: {
    ...
    // 删除关键字
    removeKeyword() {
      // 给服务器带的参数searchParmas的keyword置空
